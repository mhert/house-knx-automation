...
class SunriseSunsetEventEmitterTest {
    ...
    fun `test sunriseEvent will be emitted on sunrise`() {
        ...
        verify(eventPublisher, times(1)).publishEvent(refEq(SunriseEvent()))
        verify(eventPublisher, times(0)).publishEvent(refEq(SunsetEvent()))
    }
    ...
    fun `test sunsetEvent will be emitted on before sunrise`() {
        ...
        verify(eventPublisher, times(0)).publishEvent(refEq(SunriseEvent()))
        verify(eventPublisher, times(1)).publishEvent(refEq(SunsetEvent()))
    }
